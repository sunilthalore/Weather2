...
public class WeatherFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fiveDay = (Button) rootView.findViewById(R.id.fiveDay);
        sixteenDay = (Button) rootView.findViewById(R.id.sixteenDay);

        fiveDay.setOnClickListener(this);
        sixteenDay.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.searchCity:
                ...
                break;
            case R.id.fiveDay:
                Intent mIntent = new Intent(getContext(), FiveDayForecast.class);
                mIntent.putExtra("selectedCity", selectedCity);
                startActivity(mIntent);

                break;
            case R.id.sixteenDay:
                Intent mIntent2 = new Intent(getContext(), SixteenDayForecast.class);
                mIntent2.putExtra("selectedCity",selectedCity);
